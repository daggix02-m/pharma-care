...
const coreValues = [
  ...
  },
  {
    ...
    description: 'Your success is our success. We are committed to helping pharmacies thrive.',
  },
  {
    icon: Users,
    title: 'Compliance',
      ...
      <main className='relative z-10'>
          ...
          <div className='container px-4 md:px-6'>
            ...
            >
              ...
              <p className='mx-auto max-w-[900px] text-muted-foreground md:text-xl font-body leading-relaxed'>
                We are on a mission to empower pharmacies with cutting-edge technology that
                simplifies operations and enhances patient care.
              </p>
            </div>
          </div>
        </section>

        {/* Stats Section - Only show if enabled */}
        {aboutContent?.aboutStatsEnabled !== false && (
          <section className='w-full py-12 bg-muted/30'>
            <div className='container px-4 md:px-6'>
              <div ref={statsRef} className='grid grid-cols-2 md:grid-cols-4 gap-6'>
                {(
                  aboutContent?.aboutStats || [
                    { label: 'Pharmacies', value: '150+', description: 'Trust PharmaCare daily' },
                    { label: 'Prescriptions', value: '500K+', description: 'Processed monthly' },
                    { label: 'Uptime', value: '99.9%', description: 'Guaranteed reliability' },
                  ...
                  >
                    ...
                    <span className='text-sm font-medium text-foreground mt-2'>{stat.label}</span>
          ...
          <div className='container px-4 md:px-6'>
            <div ref={storyRef} className='grid gap-12 lg:grid-cols-2 items-center'>
              <div className='space-y-6'>
                ...
                <p className='text-muted-foreground md:text-lg font-body leading-relaxed'>
                  We have seen firsthand the challenges pharmacy owners face - from managing
                  multi-branch operations to keeping track of inventory and ensuring compliance with
                  regulations. Our platform was built by pharmacy owners, for pharmacy owners.
                </p>
              </div>
              <div className='relative'>
                <div className='aspect-square rounded-2xl bg-gradient-to-br from-primary/20 via-primary/10 to-muted overflow-hidden flex items-center justify-center border border-border'>
                  <div className='text-center p-8'>
                    ...
                    <p className='text-muted-foreground mt-2'>By Pharmacy Owners</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div ref={missionRef} className='grid gap-12 lg:grid-cols-2'>
              ...
              <div className='bg-white/50 backdrop-blur-sm rounded-2xl border border-border p-8 shadow-sm'>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <h3 className='text-2xl font-bold text-foreground font-display'>Our Mission</h3>
                </div>
                <p className='text-muted-foreground md:text-lg font-body leading-relaxed'>
              ...
              <div className='bg-white/50 backdrop-blur-sm rounded-2xl border border-border p-8 shadow-sm'>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <h3 className='text-2xl font-bold text-foreground font-display'>Our Vision</h3>
                </div>
                <p className='text-muted-foreground md:text-lg font-body leading-relaxed'>
        ...
        <section className='w-full py-12 md:py-24 lg:py-32'>
          <div className='container px-4 md:px-6'>
            ...
            <div ref={valuesRef} className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
              {(aboutContent?.aboutValues || coreValues.map((v) => v.title)).map((value, index) => {
                const valueData =
                  typeof value === 'string'
                    ? coreValues.find((v) => v.title === value) || coreValues[index]
                    : coreValues[index];
          ...
          <div className='container px-4 md:px-6'>
            <div className='text-center max-w-2xl mx-auto'>
              ...
              <p className='text-muted-foreground md:text-lg font-body mb-8'>
                Contact us for pricing and a personalized demo. Join pharmacies across Ethiopia
                using PharmaCare to streamline operations and improve patient care.
              </p>
