      ...
      <div className='flex items-center justify-center min-h-screen bg-background'>
        <Card className='max-w-md w-full'>
          <CardContent className='p-6 text-center'>
            ...
            <h3 className='text-xl font-semibold mb-2'>Error Loading Pharmacy</h3>
            <p className='text-muted-foreground mb-4'>Pharmacy not found</p>
            <Button onClick={() => navigate('/admin/pharmacies')} variant='outline'>
              Back to Pharmacies
            </Button>
          </CardContent>
        </Card>
    ...
    <div className='min-h-screen bg-gradient-to-br from-background via-background to-[hsl(var(--medical-teal))]/5'>
          ...
          <div className='flex items-start justify-between gap-6'>
            <div className='flex-1'>
              <div className='flex items-center gap-3 mb-2'>
                ...
                <div>
                  <h1 className='text-3xl font-bold tracking-tight'>{data.pharmacy.name}</h1>
              ...
              <div className='flex items-center gap-3 mt-4'>
                <Badge
                  variant={data.pharmacy.status === 'active' ? 'default' : 'destructive'}
            ...
            <div className='flex items-center gap-2'>
              <Button onClick={() => setMessageDialog(true)} variant='outline' className='gap-2'>
      ...
      <div className='container mx-auto px-6 py-8'>
        <div className='space-y-4 max-w-7xl'>
          ...
          >
            <PharmacyOverviewSection pharmacy={data.pharmacy} branches={data.branches} />
          </CollapsibleSection>
      ...
      <Dialog open={suspendDialog} onOpenChange={setSuspendDialog}>
        <DialogContent className='max-w-md'>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to suspend <strong>{data.pharmacy.name}</strong>? This action
              will:
            </DialogDescription>
          </DialogHeader>
