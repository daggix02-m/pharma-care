...
type AppealItem = ManagerFlagAppeal | AdminActionAppeal;
...
function getStatusBadge(appeal: AppealItem) {
  if (appeal.type === "manager_flag") {
    switch (appeal.status) {
      case "flagged":
        return (
          <Badge className="bg-amber-500 hover:bg-amber-600">Flagged</Badge>
        );
      case "reviewed":
    ...
    switch (appeal.actionStatus) {
      ...
      case "lifted_by_admin":
        return (
          <Badge className="bg-emerald-500 hover:bg-emerald-600">Lifted</Badge>
        );
      case "lifted_by_owner":
        return (
          <Badge className="bg-blue-500 hover:bg-blue-600">Resolved</Badge>
        );
      default:
        return <Badge variant="outline">Unknown</Badge>;
    }
...
interface ManagerFlagCardProps {
  appeal: ManagerFlagAppeal;
  isExpanded: boolean;
  onToggle: (id: string) => void;
}

export function ManagerFlagCard({
  appeal,
  isExpanded,
  onToggle,
}: ManagerFlagCardProps) {
  return (
    <Card
      className={cn(
            ...
            <div className="flex items-start gap-2 p-3 rounded-lg bg-red-50/50 dark:bg-red-950/20 border border-red-200 dark:border-red-900">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 dark:text-red-300">
                  The flag remains active. The admin reviewed your response and
                  decided to maintain the flag.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="flex items-start gap-2 p-3 rounded-lg bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900">
              ...
              <div>
                ...
                <p className="text-sm text-emerald-700 dark:text-emerald-300">
                  Your appeal was successful. The flag has been dismissed and
                  removed from your manager's record.
                </p>
              </div>
            </div>
          )}
          ...
          {appeal.actionStatus === "lifted_by_admin" && (
            <div className="flex items-start gap-2 p-3 rounded-lg bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900">
              ...
              <div>
                ...
                <p className="text-sm text-emerald-700 dark:text-emerald-300">
                  Your appeal was successful. The admin has lifted this action
          ...
          {appeal.actionStatus === "active" && (
            <div className="flex items-start gap-2 p-3 rounded-lg bg-red-50/50 dark:bg-red-950/20 border border-red-200 dark:border-red-900">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 dark:text-red-300">
                  This admin action is still in effect. You may need to take
                  corrective action or wait for review.
                </p>
              </div>
            </div>
          )}
...
export type { ManagerFlagAppeal, AdminActionAppeal };
