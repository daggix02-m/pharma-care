                ...
                <tbody>
                  {payments.map((payment) => (
                    <tr key={payment._id} className='border-b hover:bg-muted/50'>
                      <td className='py-3 px-4 font-medium'>#{payment._id}</td>
                      ...
                      <td className='py-3 px-4'>
                        <div className='flex items-center gap-2'>
                          ...
                          <span className='font-medium'>{payment.items?.length || 0} items</span>
                        </div>
                      </td>
                      <td className='py-3 px-4'>
                        <div className='flex items-center gap-2'>
                          <DollarSign className='h-4 w-4 text-muted-foreground' />
                          <span className='font-medium'>ETB {payment.totalAmount?.toFixed(2)}</span>
                        </div>
                      </td>
