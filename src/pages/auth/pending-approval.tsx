...
export function PendingApprovalPage() {
  ...
  const pharmacyName =
    localStorage.getItem("pendingPharmacyName") || "Your Pharmacy";
  const pendingEmail = localStorage.getItem("pendingEmail") || "";
  const pendingRequestType =
    localStorage.getItem("pendingRequestType") || "branch_manager";
  ...
  const pollStatus = useCallback(async () => {
    ...
    try {
      const userApproved = accountStatus?.status === "active";
      const pharmacyApproved =
        accountStatus?.pharmacyStatus === "active" ||
        accountStatus?.pharmacyStatus === "approved";
      if (userApproved && pharmacyApproved) {
        setApproved(true);
        setPolling(false);
