      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            ...
            <SheetDescription className='sr-only'>Navigation sidebar for mobile</SheetDescription>
...
const SidebarRail = forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => {
    const { toggleSidebar } = useSidebar();
...
const SidebarInset = forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ({ className, ...props }, ref) => {
    return (
      <main
...
const SidebarInput = forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
  ({ className, ...props }, ref) => {
    return (
      <Input
        ref={ref}
        data-sidebar='input'
        className={cn(
          'h-8 w-full bg-background focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
        {...props}
      />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none transition-[margin,opacity] ease-linear focus-visible:outline-none [&>svg]:size-4 [&>svg]:shrink-0',
...
const SidebarGroupContent = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
...
const SidebarMenuBadge = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
  ...
  ({ className, showIcon = false, ...props }, ref) => {
    return (
      ...
      >
        ...
        <Skeleton className='h-4 flex-1 max-w-[70%]' data-sidebar='menu-skeleton-text' />
      </div>
    );
  }
);
...
const SidebarMenuSubItem = forwardRef<HTMLLIElement, React.HTMLAttributes<HTMLLIElement>>(
