...
export const ProfileSettings = ({ userRole = 'User', user }: ProfileSettingsProps) => {
  ...
  const handleDeletePhoto = async () => {
    ...
    try {
      ...
      if (response.message && response.message.includes('Clerk')) {
        toast.success(
          'Profile pictures are managed by Clerk. Use your Clerk account settings to delete.'
        );
          ...
          <form onSubmit={handleProfileSubmit} className='space-y-6'>
            ...
            <div className='p-3 bg-blue-50 border border-blue-200 rounded-md'>
              <p className='text-sm text-blue-700'>
                Profile editing is currently restricted. Please contact your system administrator to
