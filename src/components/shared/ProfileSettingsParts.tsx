...
export function ProfileCard({ userRole = "User", user }: ProfileCardProps) {
  ...
  const uploadProfilePictureMutation = useMutation(
    api.auth.mutations.uploadProfilePicture,
  );
  const deleteProfilePictureMutation = useMutation(
    api.auth.mutations.deleteProfilePicture,
  );
  ...
  const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onload = async (event) => {
        ...
        const response = await uploadProfilePictureMutation({
          imageUrl: base64,
        });
        toast.success(
        ...
        <form onSubmit={handleProfileSubmit} className="space-y-6">
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
            <p className="text-sm text-blue-700">
              Profile editing is currently restricted. Please contact your
              system administrator to update your personal information.
            </p>
          </div>

          <div className="flex justify-end">
            <Button type="submit" disabled={isUpdatingProfile || true}>
...
export function PasswordCard({}: PasswordCardProps) {
