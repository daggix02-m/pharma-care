...
export function LockAccountDialog({
  ...
  const lockManagerMutation = useMutation(
    api.admin.mutations.temporaryLockManager,
  );
        ...
        {!showConfirm ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                This will immediately block the account from logging in. All
                active sessions will be terminated. The owner will be notified.
              </DialogDescription>
            </DialogHeader>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-800 mt-1">
                      This action will immediately block the user from accessing
                      the system. Only use this for urgent security concerns or
                      suspicious activity.
                    </p>
                  </div>
                </div>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Please review the details before confirming. This action cannot
                be undone without owner review.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="bg-amber-50/50 border border-amber-200 rounded-lg p-3 flex items-start gap-2">
                ...
                <p className="text-xs text-amber-800">
                  This will immediately terminate all active sessions and
                  prevent login. The owner will be notified and can review this
                  action.
                </p>
              </div>
            </div>
