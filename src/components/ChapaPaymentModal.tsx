...
export function ChapaPaymentModal({ open, onClose, amount, onSuccess }: ChapaPaymentModalProps) {
          ...
          <div className='space-y-6 text-center py-8'>
            ...
            {paymentResult && (
              <div className='space-y-3 p-4 bg-slate-50 rounded-xl'>
                ...
                <div className='flex justify-between text-sm'>
                  <span className='text-slate-500'>Method</span>
                  <span className='font-medium'>{(paymentResult as any).paymentMethod}</span>
                </div>
              </div>
            )}
          </div>
