  ...
  return (
    <div className='min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden'>
      ...
      <div ref={containerRef} className='text-center max-w-md mx-auto'>
        ...
        <p ref={subtitleRef} className='text-xl text-muted-foreground mb-2 font-medium'>
          Your message has been received
        </p>

        <p ref={messageRef} className='text-muted-foreground mb-8 leading-relaxed'>
          Our team is reviewing your message and we'll get back to you as soon as possible.
        </p>
        ...
        <p className='mt-8 text-sm text-muted-foreground'>Expected response time: 24-48 hours</p>
      </div>

      {/* Decorative elements */}
      <div ref={footerRef} className='absolute bottom-8 text-center'>
        <p className='text-xs text-muted-foreground/60'>
          © 2024 PharmaCare Platform. All rights reserved.
        </p>
      </div>
    </div>
  );
