                          ...
                          <div className='flex items-center gap-3'>
                            ...
                            <div>
                              <p className='font-bold text-slate-900'>
                                {new Date(s.start_time || s.created_at).toLocaleDateString()}
                              </p>
                              <p className='text-[10px] font-bold text-slate-400 uppercase tracking-widest'>
                                {new Date(s.start_time || s.created_at).toLocaleTimeString()} -{' '}
                                {s.end_time ? new Date(s.end_time).toLocaleTimeString() : 'N/A'}
                              </p>
                            </div>
                          </div>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div>
                ...
                <p className='text-sm text-white/80 leading-relaxed'>
                  Always ensure your cash drawer matches the recorded transactions. Reported
                  discrepancies are audited daily by management.
                </p>
              </div>
            </div>
          </Card>
