...
export function OwnerDetailsSection({ owner, pharmacy }: OwnerDetailsSectionProps) {
  return (
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          <DetailSection
            ...
            data={[
              ...
              { label: 'Date Created', value: new Date(owner._creationTime).toLocaleDateString() },
              {
                label: 'Last Login',
                value: 'N/A',
              },
          ...
          <DetailSection
            ...
            data={[
              ...
              { label: 'Postal Code', value: pharmacy.address?.postalCode || 'N/A' },
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          <DetailSection
            ...
            data={[
              ...
              { label: 'Year Established', value: pharmacy.yearEstablished?.toString() || 'N/A' },
              {
                label: 'Estimated Monthly Prescriptions',
                value: pharmacy.estimatedMonthlyPrescriptions?.toString() || 'N/A',
              },
            ]}
          />
          <DetailSection
            ...
            data={[
              ...
              { label: 'Issuing Authority', value: pharmacy.issuingAuthority || 'N/A' },
              {
      ...
      <TabsContent value='billing' className='mt-6'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          <DetailSection
            ...
            icon={Mail}
            data={[
              { label: 'Billing Email', value: pharmacy.billingContactEmail || 'N/A' },
              { label: 'Contact Phone', value: pharmacy.primaryContactPhone || 'N/A' },
            ]}
          />
          <DetailSection
            ...
            data={[
              {
                label: 'Street',
                value: pharmacy.billingAddress?.street || pharmacy.address?.street || 'N/A',
              },
              {
                label: 'City',
                value: pharmacy.billingAddress?.city || pharmacy.address?.city || 'N/A',
              },
              {
                label: 'State',
                value: pharmacy.billingAddress?.state || pharmacy.address?.state || 'N/A',
              },
              {
                label: 'Country',
                value: pharmacy.billingAddress?.country || pharmacy.address?.country || 'N/A',
              },
            ]}
          />
        </div>
        ...
        <Card className='mt-6 border-2 border-border'>
          ...
          <CardContent className='space-y-3'>
            <div className='flex justify-between items-center p-3 bg-muted/30 rounded-lg'>
              ...
              <Badge variant='outline'>{pharmacy.subscriptionTier?.toUpperCase() || 'BASIC'}</Badge>
            </div>
            <div className='flex justify-between items-center p-3 bg-muted/30 rounded-lg'>
              <span className='text-sm'>Monthly Cost</span>
              <span className='text-sm font-semibold'>${pharmacy.monthlyCost || 0}/month</span>
            </div>
            <div className='flex justify-between items-center p-3 bg-muted/30 rounded-lg'>
            ...
            <div className='flex justify-between items-center p-3 bg-muted/30 rounded-lg'>
              ...
              <Badge variant={pharmacy.paymentStatus === 'paid' ? 'default' : 'destructive'}>
...
function SecurityCard({ title, icon: Icon, value, status }: SecurityCardProps) {
  const statusConfig = {
    ...
    warning: { bg: 'bg-yellow-500/10', text: 'text-yellow-600', border: 'border-yellow-500/30' },
    neutral: { bg: 'bg-muted/30', text: 'text-muted-foreground', border: 'border-border' },
  };
