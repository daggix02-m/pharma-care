...
export function VerifyEmailPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.success(
        'Email verification is handled by Clerk. Please check your email for the verification link.'
      );
    } catch (err: any) {
  ...
  const handleResendCode = async () => {
    ...
    try {
      // Email verification is handled by Clerk
      toast.success(
        'Verification emails are handled by Clerk. Check your email for the verification link.'
      );
    } catch (err: any) {
