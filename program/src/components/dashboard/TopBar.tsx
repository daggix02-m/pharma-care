...
const NAV_CONFIG: Record<string, NavItem[]> = {
  admin: [
    ...
    { label: 'Audit Logs', path: '/admin?tab=audit', icon: ClipboardList },
  ...
  pharmacist: [
    { label: 'Overview', path: '/pharmacist?tab=overview', icon: LayoutDashboard },
    { label: 'Medicines', path: '/pharmacist?tab=medicines', icon: Package },
    { label: 'Expiry Alerts', path: '/pharmacist?tab=expiry', icon: Bell },
    { label: 'Stock Requests', path: '/pharmacist?tab=stock', icon: ClipboardList },
  ...
  return (
    <Link to={homePath} className='flex items-center gap-3 group'>
      <div className='relative w-10 h-10 flex items-center justify-center overflow-hidden'>
        <img src='/favicon.png' alt='PharmaCare' className='h-10 w-10 object-contain' />
      </div>
