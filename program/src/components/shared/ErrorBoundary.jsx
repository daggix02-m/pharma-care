    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center animate-fade-up">
          <div className="w-20 h-20 rounded-[2rem] bg-red-50 dark:bg-red-500/10 flex items-center justify-center mb-6 shadow-xl shadow-red-500/10">
            <AlertTriangle className="h-10 w-10 text-red-500" />
          </div>
          <h2 className="text-3xl font-black text-slate-900 dark:text-slate-50 mb-2">Something went wrong</h2>
          ...
          {process.env.NODE_ENV === 'development' && (
              <div className="mt-12 p-4 bg-slate-50 rounded-2xl border border-slate-100 text-left max-w-2xl overflow-auto">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Developer Info</p>
